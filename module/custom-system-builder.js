...
Hooks.once("init", async function () {
  ...
  componentFactory.addComponentType(
...
Hooks.once("ready", async function () {
  ...
  for (let template of game.actors.filter(
    (actor) => actor.type === "_template"
  )) {
    let headerProps = template.templateSystem._fetchSpecialFields(
    ...
    let bodyProps = template.templateSystem._fetchSpecialFields(
...
function createExportButtons(sidebar, jq) {
  ...
  exportButton.innerHTML =
    '<i class="fas fa-download"></i>Esporta templates JSON';
  ...
  importButton.innerHTML =
    '<i class="fas fa-upload"></i>Importa templates JSON';
  ...
  exportTitle.innerText = "Vulcania";
